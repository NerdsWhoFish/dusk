...
// as observation.
func TestADR0054_ACrashedPluginIsStartedAgain(t *testing.T) {
...
func TestADR0054_ARestartIsNeverAnEmptyObservation(t *testing.T) {
...
func TestADR0054_APluginThatWillNotStayUpIsLeftFailed(t *testing.T) {
...
func TestADR0054_AnActionInterruptedByTheProcessSaysSo(t *testing.T) {
	tests := []struct {
		name  string
		id    string
		class int32
...
func TestADR0054_ADeliberateStopIsNotACrash(t *testing.T) {
...
func TestADR0054_TwoDusksDoNotShareASocket(t *testing.T) {
