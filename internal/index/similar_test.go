...
func bodyNote(id, kind, body string) *duskv1alpha1.Note {
...
func TestSimilarNotes(t *testing.T) {
	...
	db := newDB(t)
	seedNotes(t, db,
		bodyNote(".dusk/gotcha-transcoding.md", "gotcha", transcoding),
		bodyNote(".dusk/todo-transcoding.md", "todo", transcoding),
		bodyNote(".dusk/gotcha-library.md", "gotcha", unrelated),
	)
...
func TestSimilarNotesRanksTheClosestFirst(t *testing.T) {
	db := newDB(t)
	seedNotes(t, db,
		bodyNote(".dusk/gotcha-reworded.md", "gotcha", reworded),
		bodyNote(".dusk/gotcha-exact.md", "gotcha", transcoding),
	)
...
func TestSimilarNotesRespectsTheLimit(t *testing.T) {
	db := newDB(t)
	seedNotes(t, db,
		bodyNote(".dusk/a.md", "gotcha", transcoding),
		bodyNote(".dusk/b.md", "gotcha", transcoding),
		bodyNote(".dusk/c.md", "gotcha", reworded),
	)
