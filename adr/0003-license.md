...
Dusk is intended to be adopted by platform teams inside companies, and its plugin ecosystem depends on third parties writing integrations without legal friction.
Both of those goals are shaped by the license before a single line of code is written.
