...
- A restricted viewer's drift and integrity blocks are not filtered, so counts there can include things the viewer cannot open. Recorded as a gap rather than fixed. **Closed by [ADR-0051](0051-a-count-is-of-what-the-viewer-can-see.md)**, see the amendment below.
...
The Bad consequence above is closed by [ADR-0051](0051-a-count-is-of-what-the-viewer-can-see.md), which also qualifies a claim made here.
